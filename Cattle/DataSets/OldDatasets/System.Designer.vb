...
Partial Public Class DataSet1
    ...
    Partial Public Class userDataTable
        ...
        Public Overloads Function AdduserRow() As userRow
            ...
            rowuserRow.ItemArray = New Object(-1) {}
    ...
    Public Class userRowChangeEvent
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub New(ByVal row As userRow, ByVal action As System.Data.DataRowAction)
            MyBase.New
            Me.eventRow = row
...
Namespace DataSet1TableAdapters
    ...
    Partial Public Class userTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT `Host`, `User`, `Password` FROM `mysql`..`user`"
