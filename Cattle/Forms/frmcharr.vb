Public Class frmcharr
    ...
    Public Property TheId() As String
        ...
        End Set
    End Property
    Private Sub frmcharr_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Me.curTable = "COW" Then
            ...
            End If
            TextBox1.DataBindings.Add("Text", CowBindingSource, "cha", _
        ...
        Else
            ...
            End If
            TextBox1.DataBindings.Add("Text", CalfBindingSource, "charr", _
                                True, DataSourceUpdateMode.OnPropertyChanged)
        End If
